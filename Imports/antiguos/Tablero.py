...
import pyodbc
class Tablucho(QWidget,Ui_MainWindow):
    def __init__(self):
        ...
        self.resize(828, 506)
        self.ui.stackedWidget.setFixedSize(674, 424)
    ...
    def mostrar_pagina_tabla(self):
        ...
        # Desconectar señales antes de conectarlas nuevamente
    ...
    def mostrar_pagina_actualizar(self):
        self.ui.stackedWidget.setCurrentWidget(self.ui.pagina_Actualizar_2)
    def Actualizar_Buscar(self):
        if self.ui.TXT_NOMBRE_PRODUCTO_2.text() != "":
            ...
            if codeProduct in actid_inventario:
                ...
                self.ui.TXT_CODIGO_3.setText(ACTid_Producto[Ind])
    ...
    def actualizar_producto(self):
        if self.Verificaion == True:
            ...
            # Crear un cursor para ejecutar consultas SQL
            codeProduct =self.ui.TXT_NOMBRE_PRODUCTO_2.text()
            code = self.ui.TXT_CODIGO_3.text()
